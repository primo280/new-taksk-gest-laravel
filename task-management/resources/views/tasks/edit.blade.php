...
<body class="bg-gray-100">
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="form-container">
            <h1 class="text-center text-3xl font-bold text-blue-500 mb-4">Modifier la tâche</h1>
            ...
            <form action="{{ route('tasks.update', $task) }}" method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control input-custom ps-5" id="title" name="title" value="{{ $task->title }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <textarea class="form-control input-custom ps-5" id="description" name="description" rows="4">{{ $task->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="date" class="form-control input-custom ps-5" id="deadline" name="deadline" value="{{ $task->deadline }}" required>
                    </div>
                </div>
