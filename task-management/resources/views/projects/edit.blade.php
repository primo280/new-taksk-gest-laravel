...
<body class="bg-gray-100">
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="form-container">
            <h1 class="text-center text-3xl font-bold text-blue-500 mb-4">Modifier le projet</h1>
            ...
            <form action="{{ route('projects.update', $project) }}" method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        <i class="fas fa-heading form-icon text-blue-500"></i>
                        <input type="text" class="form-control input-custom ps-5" id="title" name="title" value="{{ $project->title }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        <i class="fas fa-pen form-icon text-blue-500"></i>
                        <textarea class="form-control input-custom ps-5" id="description" name="description" rows="4">{{ $project->description }}</textarea>
                    </div>
                </div>

                <!-- Date limite -->
                <div class="form-group mb-4">
                    <label for="deadline" class="form-label text-lg font-medium">Date limite</label>
                    <div class="position-relative">
                        <i class="fas fa-calendar-alt form-icon text-blue-500"></i>
                        <input type="date" class="form-control input-custom ps-5" id="deadline" name="deadline" value="{{ $project->deadline }}" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        <i class="fas fa-clipboard-check form-icon text-blue-500"></i>
                        <select id="status" name="status" class="form-select input-custom ps-5">
