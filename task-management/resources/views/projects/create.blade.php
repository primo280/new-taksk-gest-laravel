...
<body class="bg-gray-100">
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="form-container">
            <h1 class="text-center text-3xl font-bold text-blue-500 mb-4">Créer un Projet</h1>
            ...
            <form action="{{ route('projects.store') }}" method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <textarea class="form-control input-custom ps-5" id="description" name="description" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="date" class="form-control input-custom ps-5" id="deadline" name="deadline" required>
                    </div>
                </div>
